...
public class SwitchLoader extends BinaryLoader
{
    ...
    protected List<Loaded<Program>> loadProgram(Loader.ImporterSettings settings)
        ...
        Address baseAddr = importerLanguage.getAddressFactory()
        ...
        try
        {
            ...
            String root = settings.projectRootPath();
            if (root == null || root.isEmpty()) {
                root = "/";
            }
            String folder = root + settings.importPathOnly();
    ...
    protected void loadProgramInto(Program program, Loader.ImporterSettings settings)
        ...
        MessageLog log = settings.log(); // useful
